...
export const commonValidations = {
  licensePlate: body('licensePlate')
    ...
    .withMessage('License plate must be 2-20 characters, alphanumeric with hyphens and spaces only'),
  ...
  name: body('name')
    ...
    .withMessage('Name must be 1-100 characters, alphanumeric with spaces, hyphens, underscores, and periods'),
