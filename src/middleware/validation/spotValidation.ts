...
interface SpotUpdateBody {
  status?: string;
  type?: string;
  features?: string[];
}

interface SpotQueryParams {
  include?: string;
  sort?: string;
  order?: string;
}
 ...
 */
export const validateSpotQuery = (req: TypedRequest, res: Response, next: NextFunction): void => {
  try {
 ...
 */
export const validateSpotUpdate = (req: TypedRequest<SpotUpdateBody>, res: Response, next: NextFunction): void => {
 ...
 */
export const sanitizeSpotUpdate = (req: TypedRequest<SpotUpdateBody>, res: Response, next: NextFunction): void => {
  const updates: Partial<SpotUpdateBody> = {};
 ...
 */
export const validateIncludeParams = (req: TypedRequest<any, SpotQueryParams>, res: Response, next: NextFunction): void => {
 ...
 */
export const validateSortParams = (req: TypedRequest<any, SpotQueryParams>, res: Response, next: NextFunction): void => {
