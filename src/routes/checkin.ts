...
router.post('/',
  ...
  sanitizeCheckinRequest,
  validateCheckinRequest,
  (req: Request, res: Response): void => checkinController.checkIn(req, res)
);
...
router.post('/simulate',
  ...
  validateRequestBody,
  sanitizeCheckinRequest,
  (req: Request, res: Response): void => checkinController.simulateCheckin(req, res)
);
...
router.get('/availability',
  (req: Request, res: Response): void => checkinController.getGeneralAvailability(req, res)
);
...
router.get('/availability/:vehicleType',
  (req: Request, res: Response): void => checkinController.getAvailabilityByVehicleType(req, res)
);
 ...
 */
router.get('/stats',
  (req: Request, res: Response): void => checkinController.getCheckinStats(req, res)
);
 ...
 */
router.get('/health',
  (req: Request, res: Response): void => checkinController.healthCheck(req, res)
);
