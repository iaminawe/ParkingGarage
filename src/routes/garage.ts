 ...
 * - 500: Server error
 */
router.get('/', validateGarageQuery, async (req: Request, res: Response): Promise<void> => {
 ...
 * - 500: Server error
 */
router.put('/rates', validateRateUpdate, async (req: Request, res: Response): Promise<void> => {
