...
router.post('/',
  ...
  sanitizeCheckoutRequest,
  validateCheckoutRequest,
  (req: Request, res: Response): void => checkoutController.checkOut(req, res)
);
...
router.post('/simulate',
  ...
  validateRequestBody,
  sanitizeCheckoutRequest,
  (req: Request, res: Response): void => checkoutController.simulateCheckout(req, res)
);
 ...
 */
router.get('/stats',
  (req: Request, res: Response): void => checkoutController.getCheckoutStats(req, res)
);
...
router.get('/ready',
  validateCheckoutListQuery,
  (req: Request, res: Response): void => checkoutController.getVehiclesReadyForCheckout(req, res)
);
...
router.get('/estimate/:licensePlate',
  validateLicensePlateParam,
  (req: Request, res: Response): void => checkoutController.getCurrentEstimate(req, res)
);
...
router.post('/force',
  ...
  sanitizeCheckoutRequest,
  validateForceCheckoutRequest,
  (req: Request, res: Response): void => checkoutController.forceCheckout(req, res)
);
 ...
 */
router.get('/health',
  (req: Request, res: Response): void => checkoutController.healthCheck(req, res)
);
